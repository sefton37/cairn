...
def handle_ollama_status(db: Database) -> dict[str, Any]:
    ...
    from cairn.ollama import check_ollama, list_ollama_models, list_ollama_models_detailed
...
def handle_ollama_set_url(db: Database, *, url: str) -> dict[str, Any]:
    """Set Ollama URL."""
    from cairn.ollama import check_ollama
...
def handle_ollama_set_model(db: Database, *, model: str) -> dict[str, Any]:
    ...
    from cairn.ollama import list_ollama_models
    from cairn.settings import settings
...
def handle_ollama_check_installed(_db: Database) -> dict[str, Any]:
    ...
    from cairn.providers import check_ollama_installed, get_ollama_install_command
...
def handle_providers_set(db: Database, *, provider: str) -> dict[str, Any]:
    ...
    from cairn.providers import set_provider_type, get_provider_info, LLMError
