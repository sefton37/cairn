...
class CairnAtomicBridge:
    ...
    def __init__(
        ...
        from cairn.cairn.behavior_modes import create_default_registry
    ...
    def process_request(
        ...
        from cairn.cairn.behavior_modes import BehaviorModeContext
    ...
    def _execute_behavior_mode(
        ...
        """
        from cairn.cairn.consciousness_stream import ConsciousnessEventType, ConsciousnessObserver
    ...
    def _generate_mode_response(
        ...
        from cairn.cairn.intent_engine import IntentCategory
