...
from cairn.rpc_handlers.archive import (
...
from cairn.rpc_handlers.context import handle_context_stats, handle_context_toggle_source
from cairn.rpc_handlers.documents import (
...
from cairn.rpc_handlers.providers import (
...
async def logout(bearer_val: str = Depends(require_auth)) -> dict[str, Any]:
    ...
    from cairn.rpc_handlers.http_auth import http_logout
