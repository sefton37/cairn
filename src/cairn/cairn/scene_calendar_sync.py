...
def sync_scene_to_calendar(
    ...
    """
    try:
        from cairn.cairn.thunderbird_bridge import create_calendar_event_for_beat
    except ImportError:
...
def update_scene_calendar_event(
    ...
    """
    try:
        from cairn.cairn.thunderbird_bridge import update_calendar_event_for_beat
    except ImportError:
        logger.debug("Thunderbird bridge not available")
        return False
...
def delete_scene_calendar_event(thunderbird_event_id: str) -> bool:
    ...
    """
    try:
        from cairn.cairn.thunderbird_bridge import delete_calendar_event_for_beat
    except ImportError:
        logger.debug("Thunderbird bridge not available")
        return False
...
def is_outbound_sync_available() -> bool:
    ...
    """
    try:
        from cairn.cairn.thunderbird_bridge import is_bridge_available
...
def create_scene_with_calendar_sync(
    ...
    """
    from cairn.play_fs import create_scene
...
def delete_scene_with_calendar_sync(
    ...
    """
    from cairn.play_fs import delete_scene
