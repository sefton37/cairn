...
from cairn.cairn.surfacing import CairnSurfacer, create_surface_context
...
class CairnToolHandler:
    ...
    def _remove_anti_pattern(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        from cairn.cairn.identity import remove_anti_pattern
    ...
    def _list_anti_patterns(self) -> dict[str, Any]:
        ...
        from cairn.cairn.identity import load_anti_patterns
    ...
    def _get_identity_summary(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        from cairn.cairn.identity import build_identity_model, get_identity_hash
    ...
    def _health_history(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        from cairn.cairn.health.snapshot import get_snapshots
