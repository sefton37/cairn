...
from cairn.context_budget import (
...
def test_parse_git_numstat_basic() -> None:
    numstat = "10\t2\tsrc/cairn/foo.py\n3\t0\tdocs/tech-roadmap.md\n"
    stats = parse_git_numstat(numstat)
    assert stats == [("src/cairn/foo.py", 10, 2), ("docs/tech-roadmap.md", 3, 0)]
...
def test_budget_should_trigger_when_over_ratio() -> None:
    budget = build_review_context_budget(
        ...
        numstat_text="1\t1\tsrc/cairn/foo.py\n",  # lines=2
        overhead_tokens=10,
